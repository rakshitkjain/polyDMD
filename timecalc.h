...
//NEW Collision_type: 1- Bounce on left side, 2- Transfer on left side (inner side), 3-Bounce on right side, 4-Transfer on right side (outer side), 0- Particles are going away, 5,6 - Spurious events, should never happen, but used to keep track of errors 
